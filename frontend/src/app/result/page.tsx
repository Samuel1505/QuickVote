          ...
          <WalletGuard message="Connect your wallet to view election results">
            {isLoading ? (
              ...
              <>
                {/* Winner Banner */}
                {hasVotes && winner && (
                  <div className="mb-12 p-8 rounded-3xl bg-linear-to-r from-yellow-400 via-orange-500 to-red-500 text-white shadow-2xl">
                    <div className="flex items-center gap-6">
                      <div className="shrink-0 w-20 h-20 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                  <div className="p-6 rounded-2xl bg-white border-2 border-gray-100 shadow-sm">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-linear-to-br from-purple-primary to-purple-light flex items-center justify-center">
                  ...
                  <div className="space-y-4">
                    {sortedContenders.map((contender, index) => {
                      ...
                      return (
                        ...
                        >
                          {/* Rank */}
                          <div className="shrink-0 w-10 h-10 rounded-full bg-linear-to-br from-purple-primary to-purple-light flex items-center justify-center">
